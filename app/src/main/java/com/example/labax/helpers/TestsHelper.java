...
public class TestsHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "newTestFix2";
    public Cursor cursor;
    public static final class Tests {
        public static final String TABLE_NAME = "newTestFixedPrior";
        ...
        public static Note getTest(Cursor cursor){
            ...
            return( new  Note(cursor.getString(titleID),cursor.getString(textID), cursor.getString(dateID), cursor.getInt(priorityID) ));
        }
