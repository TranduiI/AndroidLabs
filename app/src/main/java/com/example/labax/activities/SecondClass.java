...
public class SecondClass extends MainBaseAct{
    ...
    public void ready(View view){
        if(!tt.getText().toString().trim().equals("")&!tit.getText().toString().trim().equals("")){
            ...
            intent.putExtra(EXTRA_NOTE, new Note(tit.getText().toString(),tt.getText().toString(), new Time(System.currentTimeMillis()).toString()));
            //if(String.valueOf(getIntent().getExtras().getInt(EXTRA_ID))!=null){
